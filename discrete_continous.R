...
generate.cr<-function(n.sample,beta0,beta1,beta2,beta3,p1,p2,p3,t){
  ...
  log.t<-beta0*(1-I)+beta1*I+beta2*z1+beta3*zz2+err
  t<-exp(log.t)
  delta<-sign(t<=c)
  y=pmin(t,c)
  data<-data.frame(I,z1,zz2,t,y,c,delta)
  return(data)
}
...
#########################z1 discrete, zz2 continuous CR n=500 censor=20%######################
power.cr(5000,500,10,.5,.5)
#########################z1 discrete, zz2 continuous PS n=500 censor=20%######################
power.ps(5000,500,10,.5,.5)
#########################z1 discrete, zz2 continuous SPB n=500 censor=20%######################
power.spb(5000,500,10,.5,.5)
#########################zz1 discrete, zz2 continuous CR n=250 censor=20%######################
power.cr(5000,250,10,.5,.5)
#########################zz1 discrete, zz2 continuous PS n=250 censor=20%######################
power.ps(5000,250,10,.5,.5)
#########################z1 discrete, zz2 continuous SPB n=250 censor=20%######################
