...
####################generate dataset####################
generate.cr<-function(n.sample,beta0,beta1,beta2,beta3,p1,p2,p3,tt,rou){
...
#data<-generate.cr(0.5,0.5,.5,.5,0.5,0.5,0.5,0.1)
#mean(data$delta)
...
power.cr<-function(n.sim,n.sample,tt,beta0,beta1,rou){
  ...
  for (k in 1:n.sim){ 
    data<-generate.cr(n.sample,beta0,beta1,.5,.5,0.5,0.5,0.5,tt,rou)
    ################Fit Models############################# 
    data1<-gen.weights(data)
    model1 <- lm(log(y) ~ I+I1+z1+z2-1, weights=w,data=data1)
    model2 <- lm(log(y) ~ I+I1-1, weights=w,data=data1)
    model3 <- lm(log(y) ~ I+I1+z1-1, weights=w,data=data1)
    model4 <- lm(log(y) ~ I+I1+z2-1, weights=w,data=data1)
...
power.ps<-function(n.sim,n.sample,tt,beta0,beta1,rou){
  print(paste("running ps",n.sim,n.sample,tt,beta0,beta1,rou, sep=" "))
  #xx.names <- c("beta.hat1","beta.hat2","beta.hat3","beta.hat4","type I Err","V","SD")
  xx<-vector("list", 7)
  #names(xx) <- xx.names
  reject<-rep(0,4)
  ...
  l.beta1<-l.beta2<-l.beta3<-l.beta4<-rep(0,n.sim)
  for (k in 1:n.sim){ 
    data<-generate.ps(n.sample,beta0,beta1,.5,.5,0.5,0.5,tt,rou)
    ################Fit Models############################# 
    data1<-gen.weights(data)
    model1 <- lm(log(y) ~ I+I1+z1+z2-1, weights=w,data=data1)
    model2 <- lm(log(y) ~ I+I1-1, weights=w,data=data1)
...
power.spb<-function(n.sim,n.sample,tt,beta0,beta1,rou){
  print(paste("running spb",n.sim,n.sample,tt,beta0,beta1,rou, sep=" "))
  #xx.names <- c("beta.hat1","beta.hat2","beta.hat3","beta.hat4","type I Err","V","SD")
  xx<-vector("list", 7)
  #names(xx) <- xx.names
  reject<-rep(0,4)
  ...
  l.beta1<-l.beta2<-l.beta3<-l.beta4<-rep(0,n.sim)
  for (k in 1:n.sim){ 
    data<-generate.spb(n.sample,beta0,beta1,.5,.5,0.5,0.5,tt,rou)
    ################Fit Models############################# 
    data1<-gen.weights(data)
    model1 <- lm(log(y) ~ I+I1+z1+z2-1, weights=w,data=data1)
    model2 <- lm(log(y) ~ I+I1-1, weights=w,data=data1)
...
power.ps(5000,100,10,0.5,0.5)
power.ps(5000,100,10,0.5,0.55)
power.ps(5000,100,10,0.5,0.6)
power.ps(5000,100,10,0.5,0.65)
power.ps(5000,100,10,0.5,0.7)
power.ps(5000,100,10,0.5,0.75)
power.ps(5000,100,10,0.5,0.8)
power.ps(5000,100,10,0.5,0.85)
power.ps(5000,100,10,0.5,0.9)
#######spb#################

power.spb(5000,100,10,0.5,0.5)
power.spb(5000,100,10,0.5,0.55)
power.spb(5000,100,10,0.5,0.6)
power.spb(5000,100,10,0.5,0.65)
power.spb(5000,100,10,0.5,0.7)
power.spb(5000,100,10,0.5,0.75)
power.spb(5000,100,10,0.5,0.8)
power.spb(5000,100,10,0.5,0.85)
power.spb(5000,100,10,0.5,0.9)

power.cr(5000,500,8,0.5,0.5,0.1)
power.spb(5000,500,8,0.5,0.5,0.1)
power.ps(5000,500,8,0.5,0.5,0.1)
power.cr(5000,500,8,0.5,0.5,0.5)
power.spb(5000,500,8,0.5,0.5,0.5)
power.ps(5000,500,8,0.5,0.5,0.5)
...
n=500
tt=10
power.cr(5000,n,tt,0.5,0.5,0.1)
power.spb(5000,n,tt,0.5,0.5,0.1)
power.ps(5000,n,tt,0.5,0.5,0.1)
power.cr(5000,n,tt,0.5,0.5,0.5)
power.spb(5000,n,tt,0.5,0.5,0.5)
power.ps(5000,n,tt,0.5,0.5,0.5)
